...
namespace DecaratorDesign
{
	// Elimizde bir nesne mevcut iken, bu nesneyi farklı anlamlarda kullanmak icin kullanılan designdır.
	class Program
	{
		static void Main(string[] args)
		{
			...
			Console.WriteLine("Personal Car HirePrice: " + personalCar.HirePrice);
			Console.WriteLine("Special offer HirePrice: " + specialOffer.HirePrice);
