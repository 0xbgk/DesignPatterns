...
namespace Multiton
{
	// Singletonun cogullastırılmıs versiyonudur.
	// Belli sarta göre instancelar üretilip, o sartlara göre instanceın verilmesini saglar.
	class Program
	{
		static void Main(string[] args)
		{
			...
			Camera camera3 = Camera.GetCamera("SAMSUNG");
